...
echo -n "$GOOGLE_SERVICEINFO_PLIST_BASE64" | nkf -mBW
echo -n "$GOOGLE_SERVICEINFO_PLIST_BASE64" | nkf -mBW > /Volumes/workspace/repository/ios/GoogleService-Info.plist
